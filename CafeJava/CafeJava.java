...
public class CafeJava {
    public static void main(String[] args) {
        ...
        if(isReadyOrder1){System.out.println(customer1 + readyMessage + displayTotalMessage + dripCoffeePrice);}
        ...
        if(isReadyOrder4){System.out.println(customer4 + readyMessage + displayTotalMessage + cappuccinoPrice);}
        else{System.out.println(customer4 + pendingMessage);}
        // SAM
        System.out.println(generalGreeting + customer2 +". "+ displayTotalMessage + lattePrice * 2); // Displays "Welcome to Cafe Java, Cindhuri"
